...
const NormalCalcOverlay: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  const getVoiceHelpMessage = (step: VoiceCalculatorStep) =>
    step === 'confirm-expression'
      ...
      : 'Say a math expression like 12 plus 45. You can also say clear, delete last, back, repeat, manual, or exit.';
  ...
  const beginVoiceRecognition = (requestedStep: VoiceCalculatorStep = 'expression') => {
    ...
    const repromptAfterNoSpeech = () => {
      ...
      const nextMessage = requestedStep === 'confirm-expression'
        ...
        : 'I am still here. Say the full expression now, or say manual to stop voice.';
